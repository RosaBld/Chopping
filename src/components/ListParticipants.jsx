...
export default function ListParticipants() {
  ...
  const [showCustom2, setShowCustom2] = useState(participants.map(() => false));
                  ...
                  <div key={index}>
                    <div className="buttonsAddByFive">
                      <button 
                        ...
                        onClick={(e) => updateNewParticipantAmount(e, index, 5)}
                      >
                        5€
                      </button>
                      ...
                      <button 
                        ...
                        onClick={(e) => updateNewParticipantAmount(e, index, 10)}
                      >
                        10€
                      </button>
                      ...
                      <button 
                        ...
                        onClick={(e) => updateNewParticipantAmount(e, index, 15)}
                      >
                        15€
                      </button>
                      ...
                      <button 
                        ...
                        onClick={(e) => updateNewParticipantAmount(e, index, 20)}
                      >
                        20€
                      </button>

                      <button 
                        className={`addTo ${selectedButtons[index]?.type === 'amount' && selectedButtons[index]?.value === null ? 'selected' : ''}`} 
